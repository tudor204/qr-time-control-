        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-6 selection:bg-blue-100 selection:text-blue-700">
            <div className="w-full max-w-md">
                ...
                <div className="bg-white/80 backdrop-blur-xl p-8 md:p-10 rounded-[2.5rem] shadow-[0_20px_50px_rgba(37,99,235,0.1)] border border-white/50 w-full animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out premium-card">
                    ...
                    <form onSubmit={onSubmit} className="space-y-5">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-11 p-4 bg-slate-50 border-2 border-transparent rounded-2xl font-bold text-slate-700 outline-none focus:bg-white focus:border-blue-600/20 focus:ring-4 focus:ring-blue-600/5 transition-all duration-300"
                                        required
                                    />
                                </div>
                            </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="flex items-center bg-slate-50 border-2 border-transparent rounded-2xl 
                                            focus-within:bg-white focus-within:border-blue-600/20 
                                            focus-within:ring-4 focus-within:ring-blue-600/5 
                                ...
                                <input
                                    ...
                                    className="flex-1 p-4 bg-transparent font-bold text-slate-700 outline-none"
                                    required
                                />
                                ...
                                <button
                                    ...
                                    className="shrink-0 pr-4 text-slate-400 hover:text-blue-600 transition"
                ...
                <p className="mt-8 text-center text-slate-400 text-[10px] font-bold uppercase tracking-widest">
                    &copy; 2026 QR Time Control • v2.0
                </p>
            </div>
        </div>
    );
